...
public static class GamePatches
{
    ...
    private static IEnumerable<CodeInstruction> Objective_OnIncrementCount_Transpiler(
    ...
    private static IEnumerable<CodeInstruction> SlayObjective_OnMonsterSlain_Transpiler(
        IEnumerable<CodeInstruction> instructions,
        ILGenerator generator
    )
    {
    ...
    private static IEnumerable<CodeInstruction> GiftObjective_OnGiftGiven_Transpiler(
        IEnumerable<CodeInstruction> instructions,
        ILGenerator generator
    )
    {
    ...
    private static void ReachMineFloorObjective_OnNewValue_Postfix(
        ReachMineFloorObjective __instance,
        Farmer who,
        int new_value
    )
    {
    ...
    private static IEnumerable<CodeInstruction> DayTimeMoneyBox_draw_Transpiler(
        IEnumerable<CodeInstruction> instructions,
        ILGenerator generator
    )
    {
                ...
                .InsertAndAdvance(
                    new CodeInstruction[]
                    {
                        ...
                        new(
                            ...
                            AccessTools.DeclaredMethod(
                                typeof(QuestPingHelper),
                                nameof(QuestPingHelper.DrawQuestPingBox)
                            )
                        ),
                        new(OpCodes.Br, lbl),
                    }
