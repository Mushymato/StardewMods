    ...
    public class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            helper.ConsoleCommands.Add(
                "enchant_scythe",
                "Forge an iridium scythe in the inventory with one of Harvester(1), Horticulturist(2), Paleologist(3), Reaper(4), or None(0).",
        ...
        private void RegisterEnchantmentTypes()
        {
            ...
            // }
            spacecoreApi!.RegisterSerializerType(typeof(PaleologistEnchantment));
        ...
        public static void ConsoleEnchantScythe(string command, string[] args)
        {
            if (!Context.IsWorldReady || args.Length < 1)
                return;
            // Harvester, Horticulturist, Paleologist, Reaper
                ...
                if (item != null && item.QualifiedItemId == "(W)66")
                {
                    ...
                    switch (args[0])
                    {
                        ...
                        case "2":
                            ...
                            break;
                        case "3":
                            scythe.AddEnchantment(new PaleologistEnchantment());
                            break;
                        case "4":
